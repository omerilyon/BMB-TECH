...
const { dBinary, eBinary } = require("../devbmb/binary");
...
bmbtz({
  'nomCom': "enc",
  'aliases': ["encrypt", "obfuscate", "obfu"],
  'categorie': "Coding"
}, async (message, args, context) => {
  const {
    ms: messageSentTime,
...
bmbtz({
  ...
  try {
    ...
    try {
      ...
      const caption = "> 𝗧𝗵𝗮𝗻𝗸 𝘆𝗼𝘂 𝗳𝗼𝗿 𝗰𝗵𝗼𝗼𝘀𝗶𝗻𝗴 𝐛𝐦𝐛 𝐭𝐞𝐜𝐡";
  ...
  try {
    ...
    if (/image\/.*/.test(contentType)) {
      ...
      await zk.sendMessage(sender, {
        image: { url: fetchUrl },
        caption: "> 𝗧𝗵𝗮𝗻𝗸 𝘆𝗼𝘂 𝗳𝗼𝗿 𝗰𝗵𝗼𝗼𝘀𝗶𝗻𝗴 𝐛𝐦𝐛 𝐭𝐞𝐜𝐡"
      }, { quoted: context.ms });
