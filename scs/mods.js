...
zokou({ nomCom: "crew", categorie: "Group" }, async (dest, zk, commandeOptions) => {
...
zokou({ nomCom: "join", categorie: "Group" }, async (dest, zk, commandeOptions) => {
...
zokou({ nomCom: "jid", categorie: "Group" }, async (dest, zk, commandeOptions) => {
...
zokou({ nomCom: "block", categorie: "General" }, async (dest, zk, commandeOptions) => {
...
zokou({ nomCom: "unblock", categorie: "General" }, async (dest, zk, commandeOptions) => {
